...
Este projeto implementa um par cliente-servidor em Python, utilizando sockets.
O cliente envia requisições ao servidor para realizar operações (calculadora, processamento de strings, ordenação de dados, busca em vetores) e recebe o resultado da operação.
